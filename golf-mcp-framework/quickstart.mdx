...
### 3. Set Up GitHub OAuth (optional - for the example Tools)

The boilerplate example includes a GitHub user tool that requires OAuth authentication. To make it work:
